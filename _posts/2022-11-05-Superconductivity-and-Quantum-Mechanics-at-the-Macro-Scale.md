...
we can differentiate b/w different materials w.r.t value of resistivity i-e metals have very high values of resistivity ($10^-6 \ohm cm$ ) while insulators have high values ($10^16 \ohm cm$) .
...
$$\rho_Q = \frac{h^3}{(2\pi)^2 e^4 m_e} = 1.35 \times 10^{4} \ohm cm$$
...
![resistivity](/Aneeqasif.github.io/img/Superconductivity-and-Quantum-Mechanics-at-the-Macro-Scale/resistivity.png)
...
this 2 is an important clue which is discussed later  ^0f57ca
## Josephson Effect
...
![](/Aneeqasif.github.io/img/Superconductivity-and-Quantum-Mechanics-at-the-Macro-Scale/josephson.png))
